                ...
                {pillars.map((p, i) => (
                  ...
                  >
                    <Link
                      href={`#${p.id}`}
                      title={p.name}
                      className="group relative flex h-[140px] flex-col items-center justify-center rounded-2xl border border-paper/12 bg-paper/[0.04] backdrop-blur-sm p-4 overflow-hidden transition-all hover:border-brand/50 hover:bg-paper/[0.07] hover:-translate-y-0.5"
                    >
                      <span
                        aria-hidden
                      ...
                      />
                      <span className="absolute right-3 top-3 font-mono text-[0.55rem] uppercase tracking-[0.22em] text-mist">
                        {p.index}
                      </span>

                      <MaskedLogo
                        src={p.logoSrc}
                        className="h-12 w-[80%] transition-transform group-hover:scale-[1.04]"
                      />

                      <ArrowUpRight
                        className="absolute right-3 bottom-3 h-3.5 w-3.5 text-mist opacity-60 group-hover:opacity-100 group-hover:text-brand transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5"
                        strokeWidth={1.8}
                      />
                    </Link>
                  </motion.div>
